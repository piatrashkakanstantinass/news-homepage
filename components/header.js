...
export default function Header() {
  ...
  return (
    <div className="flex justify-between items-center sticky top-0 bg-white mb-3">
      ...
      <div
        ...
        } fixed top-0 right-0 bg-slate-500/50 md:relative max-md:min-w-full max-md:min-h-full`}
      >
        <div
          className={`${
